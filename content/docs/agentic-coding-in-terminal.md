...
| DevOps | KubeShark Kubernetes Skill | [LukasNiessen/kubernetes-skill](https://github.com/LukasNiessen/kubernetes-skill) | Failure-mode-first Kubernetes manifest generation, review, refactoring, and hardening for Claude Code and Codex. Helps reduce deprecated APIs, unsafe defaults, weak RBAC, missing resource limits, and rollout/networking mistakes |
